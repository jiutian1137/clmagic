...
Waves::Waves(Waves&& rhs)
	: mNumRows(rhs.mNumRows),
	mNumCols(rhs.mNumCols),
	mVertexCount(rhs.mVertexCount),
	mTriangleCount(rhs.mTriangleCount),
	mK1(rhs.mK1),
	mK2(rhs.mK2),
	mK3(rhs.mK3),
	mTimeStep(rhs.mTimeStep),
	mSpatialStep(rhs.mSpatialStep),
	mPrevSolution(rhs.mPrevSolution),
	mCurrSolution(rhs.mCurrSolution),
	mNormals(rhs.mNormals),
	mTangentX(rhs.mTangentX) {}

Waves& Waves::operator=(Waves&& rhs) {
	mNumRows = rhs.mNumRows;
	mNumCols = rhs.mNumCols;
	mVertexCount = rhs.mVertexCount;
	mTriangleCount = rhs.mTriangleCount;
